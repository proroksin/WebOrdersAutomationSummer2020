...
public class Driver {
    ...
    //whenever we type new Class (); we create a new obejct
    ...
    //and RemoteWebDriver is a parent of class of ChromeDriver, FirefoxDriver, etc...,classes
    //we can specify reference type as a WebDriver
    //it helps to define object type in a run time polymorphisim
